            ...
            <div class="max-w-7xl mx-auto px-4">
                <div class="flex justify-between h-16">
                    <div class="flex space-x-8">
                        <a href="#" @click.prevent="currentTab = 'tools'"
                           :class="{'border-blue-500 text-gray-900': currentTab === 'tools'}"
                           class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            工具管理
                        </a>
                        <a href="#" @click.prevent="currentTab = 'knowledge'"
                        ...
                        <a href="#" @click.prevent="currentTab = 'monitor'"
        ...
        <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                        ...
                        <div class="mb-4 border rounded p-4">
                            <div class="flex justify-between items-center mb-2">
                                ...
                                <span class="text-sm text-gray-600">
                                    <span x-text="group.enabled"></span> / <span x-text="group.total"></span> 已启用
                                </span>
                            </div>
                            
                            <!-- 工具列表 -->
                            <div class="space-y-2">
                                <template x-for="tool in getGroupTools(group.name)" :key="tool.name">
                                    <div class="flex items-center justify-between p-2 bg-gray-50 rounded">
                                        ...
                                        <label class="flex items-center cursor-pointer">
                                            ...
                                            <span class="ml-2 text-sm" x-text="tool.enabled ? '已启用' : '已禁用'"></span>
                                        </label>
                                    </div>
                                </template>
                            </div>
            ...
            <div x-show="currentTab === 'knowledge'" class="px-4 py-6 sm:px-0">
                <div class="bg-white shadow rounded-lg p-6">
                    ...
                    <div class="space-y-4" x-show="searchResults.length > 0">
                        <template x-for="result in searchResults" :key="result.document_id">
                            <div class="border rounded p-4">
                                <h3 class="font-semibold mb-2" x-text="result.title"></h3>
                                <p class="text-gray-600 text-sm mb-2" x-text="result.content"></p>
                                <span class="text-xs text-gray-500">相关性: <span x-text="result.score.toFixed(2)"></span></span>
                            </div>
                        </template>
                    </div>
                </div>
            ...
            <div x-show="currentTab === 'config'" class="px-4 py-6 sm:px-0">
                <div class="bg-white shadow rounded-lg p-6">
                    ...
                    <pre class="bg-gray-100 p-4 rounded overflow-auto" x-text="JSON.stringify(config, null, 2)"></pre>
                </div>
            </div>
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-6">
                        <div class="bg-blue-100 p-4 rounded">
                            <div class="text-2xl font-bold" x-text="stats.tools?.total || 0"></div>
                            <div class="text-sm text-gray-600">工具总数</div>
                        </div>
                        <div class="bg-green-100 p-4 rounded">
                            <div class="text-2xl font-bold" x-text="stats.tools?.enabled || 0"></div>
                            <div class="text-sm text-gray-600">已启用工具</div>
                        </div>
                        <div class="bg-purple-100 p-4 rounded">
                            <div class="text-2xl font-bold" x-text="stats.documents?.total || 0"></div>
...
function app() {
    return {
        ...
        connectWebSocket() {
            ...
            this.ws = new WebSocket(`${protocol}//${window.location.host}/api/v1/monitor/ws`);
